...
Mielőtt mélyebben belemennék a sillabuszkezelő alkalmazás implementációs részleteibe,  bemutatnék néhány modellt, amelyek az alkalmazásról adnak áttekinthetőbb képet.
...
\chapter{Megvalósítás lépések}

\section{Tartalomkezelő rendszerek}

\subsection{Általános leírás}

1. lépés: tartalomkezelő rendszer választása. Mik azok a tartalomkezelők. Miért van rá szükség? Java EE-ben milyenek vannak? (fontos: OpenCms, és Liferay)

\subsection{OpenCms}

Jelenlegi munkahelyemen ismertem meg, stb, stb... Csak nagyon röviden!

\subsection{Liferay}

\subsubsection{Általános bemutatás}

Miért erre esett a választás? (képzés miatt 6.2)
Upgrade 7.0-ra hogy történt, mi történt, milyen változás volt.

\subsubsection{Portlet, mint szabvány + a Liferay-en belül, hogy jelenik meg}

JSR akármi van???

\subsubsection{Döntés a Liferay mellett}

Egyrészt nem kérdés, hogy ez, mert ezt tanultam és akkoriban mást még nem ismertem....

\section{Alkalmazásszerver választása}

2. lépés: alkalmazásszerver választása. Tomcat vs WildFly konkrét liferay-es esetben.

\section{Adatbázisrendszer választása}

3. lépés: Adatbázisrendszer választása. Megjegyezni: egyes rendszerekkel gond volt a fejlesztés során, ezért maradt a MySQL.
